    ...
    <div className="space-y-8">
      ...
      <div className="minimal-card p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {buyers.map((buyer) => (
            <div key={buyer.id} className="border border-gray-200 rounded-lg p-6 hover:border-gray-300 transition-colors">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">{buyer.name}</h4>
              ...
              <div className="mb-4">
                <p className="text-sm font-medium text-gray-700 mb-2">Currently Buying:</p>
      ...
      <div className="minimal-card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="border border-gray-200 rounded-lg p-6">
            <h4 className="text-lg font-semibold text-gray-900 mb-3">Rice (Basmati)</h4>
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            <h4 className="text-lg font-semibold text-gray-900 mb-3">Wheat</h4>
          ...
          <div className="border border-gray-200 rounded-lg p-6">
            <h4 className="text-lg font-semibold text-gray-900 mb-3">Sugarcane</h4>
