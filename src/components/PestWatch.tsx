      ...
      <div className="minimal-card p-6">
        ...
        <div className="bg-gray-50 rounded-lg p-6 text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600 pest outbreak visualization</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
            <div className="border border-red-200 rounded-lg p-4 bg-red-50
              <div className="mb-3">
                ...
                <div className="font-semibold text-red-800 Risk Zone</div>
              </div>
              <div className="text-sm font-medium text-red-700 12</div>
            ...
            <div className="border border-yellow-200 rounded-lg p-4 bg-yellow-50
              <div className="mb-3">
                ...
                <div className="font-semibold text-yellow-800 Risk Zone</div>
              </div>
              <div className="text-sm font-medium text-yellow-700 8</div>
            ...
            <div className="border border-green-200 rounded-lg p-4 bg-green-50
              <div className="mb-3">
                ...
                <div className="font-semibold text-green-800 Zone</div>
              </div>
              <div className="text-sm font-medium text-green-700 Areas</div>
